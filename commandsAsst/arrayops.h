...
// sequentialInsert will insert x into sorted position within a,
...
// sequentialInsert complexity: sequentialInsert is O(n)
...
// orderedInsertion complexity: sequentialInsert is O(n)
